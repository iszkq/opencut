			...
			<div className="bg-muted relative aspect-video">
				<div className="absolute inset-0">
					{project.thumbnail ? (
						...
						<div className="flex size-full flex-col items-center justify-center gap-2 bg-linear-to-br from-sky-500 via-blue-600 to-violet-700 px-4 text-center text-white">
							<img
		...
		<div className="flex items-center gap-3 flex-1 min-w-0">
			<div className="bg-muted relative size-10 rounded overflow-hidden shrink-0">
				{project.thumbnail ? (
					...
					<div className="flex size-full items-center justify-center bg-linear-to-br from-sky-500 to-violet-700 text-white">
						<img
							src="/branding/electron-app-icon.png"
							alt=""
	...
	return (
		<div className="flex flex-col items-center justify-center gap-6 py-16 text-center">
			<div className="flex flex-col items-center gap-2">
				...
				<p className="text-muted-foreground max-w-md">
					创建你的第一个项目，导入素材、编辑并导出视频，所有内容都保存在本地。
				</p>
			</div>
			<NewProjectButton />
		</div>
